...
public class JOGLRubiksCube extends GLCanvas implements GLEventListener, KeyListener, MouseListener {
	...
	private void drawCube(GL2 gl) {
		...
		// top left
		gl.glPushMatrix();
			gl.glRotatef(columnLeftAngleX, ONE_F, ZERO_F, ZERO_F);
			gl.glRotatef(rowTopAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT|FACE_CUBELET_TOP|FACE_CUBELET_LEFT, cubelets[0][2][0]);
		gl.glPopMatrix();
		
		// top middle
		gl.glPushMatrix();
			gl.glRotatef(columnMiddleAngleX, ONE_F, ZERO_F, ZERO_F);
			gl.glRotatef(rowTopAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(ZERO_F, CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT|FACE_CUBELET_TOP, cubelets[1][2][0]);
		gl.glPopMatrix();
		
		// top right
		gl.glPushMatrix();
			gl.glRotatef(columnRightAngleX, ONE_F, ZERO_F, ZERO_F);
			gl.glRotatef(rowTopAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT|FACE_CUBELET_TOP|FACE_CUBELET_RIGHT, cubelets[2][2][0]);
		gl.glPopMatrix();
			
		// middle left
		gl.glPushMatrix();
			gl.glRotatef(columnLeftAngleX, ONE_F, ZERO_F, ZERO_F);
			gl.glRotatef(rowMiddleAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, ZERO_F, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT|FACE_CUBELET_LEFT, cubelets[0][1][0]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(rowMiddleAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(ZERO_F, ZERO_F, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT, cubelets[1][1][0]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, ZERO_F, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT|FACE_CUBELET_RIGHT, cubelets[2][1][0]);
		gl.glPopMatrix();
			
		// bottom left
		gl.glPushMatrix();
			gl.glRotatef(columnLeftAngleX, ONE_F, ZERO_F, ZERO_F);
			gl.glRotatef(rowBottomAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT|FACE_CUBELET_BOTTOM|FACE_CUBELET_LEFT, cubelets[0][0][0]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(ZERO_F, -CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT|FACE_CUBELET_BOTTOM, cubelets[1][0][0]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceFrontAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_FRONT|FACE_CUBELET_BOTTOM|FACE_CUBELET_RIGHT, cubelets[2][0][0]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			gl.glRotatef(columnLeftAngleX, ONE_F, ZERO_F, ZERO_F);
			gl.glRotatef(rowTopAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceMiddleAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT, ZERO_F);
			drawCubelet(gl, FACE_CUBELET_TOP|FACE_CUBELET_LEFT, cubelets[0][2][1]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(rowTopAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceMiddleAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(ZERO_F, CUBELET_TRANSLATION_UNIT, ZERO_F);
			drawCubelet(gl, FACE_CUBELET_TOP, cubelets[1][2][1]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceMiddleAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT, ZERO_F);
			drawCubelet(gl, FACE_CUBELET_TOP|FACE_CUBELET_RIGHT, cubelets[2][2][1]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(rowMiddleAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceMiddleAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, ZERO_F, ZERO_F);
			drawCubelet(gl, FACE_CUBELET_LEFT, cubelets[0][1][1]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceMiddleAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, ZERO_F, ZERO_F);
			drawCubelet(gl, FACE_CUBELET_RIGHT, cubelets[2][1][1]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceMiddleAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT, ZERO_F);
			drawCubelet(gl, FACE_CUBELET_BOTTOM|FACE_CUBELET_LEFT, cubelets[0][0][1]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceMiddleAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(ZERO_F, -CUBELET_TRANSLATION_UNIT, ZERO_F);
			drawCubelet(gl, FACE_CUBELET_BOTTOM, cubelets[1][0][1]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceMiddleAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT, ZERO_F);
			drawCubelet(gl, FACE_CUBELET_BOTTOM|FACE_CUBELET_RIGHT, cubelets[2][0][1]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			gl.glRotatef(columnLeftAngleX, ONE_F, ZERO_F, ZERO_F);
			gl.glRotatef(rowTopAngleY, ZERO_F, ONE_F, ZERO_F);
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR|FACE_CUBELET_TOP|FACE_CUBELET_LEFT, cubelets[0][2][2]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(ZERO_F, CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR|FACE_CUBELET_TOP, cubelets[1][2][2]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR|FACE_CUBELET_TOP|FACE_CUBELET_RIGHT, cubelets[2][2][2]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, ZERO_F, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR|FACE_CUBELET_LEFT, cubelets[0][1][2]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(ZERO_F, ZERO_F, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR, cubelets[1][1][2]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, ZERO_F, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR|FACE_CUBELET_RIGHT, cubelets[2][1][2]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(-CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR|FACE_CUBELET_BOTTOM|FACE_CUBELET_LEFT, cubelets[0][0][2]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(ZERO_F, -CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR|FACE_CUBELET_BOTTOM, cubelets[1][0][2]);
		gl.glPopMatrix();
		...
		gl.glPushMatrix();
			...
			gl.glRotatef(faceRearAngleZ, ZERO_F, ZERO_F, ONE_F);
			gl.glTranslatef(CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT, -CUBELET_TRANSLATION_UNIT);
			drawCubelet(gl, FACE_CUBELET_REAR|FACE_CUBELET_BOTTOM|FACE_CUBELET_RIGHT, cubelets[2][0][2]);
		gl.glPopMatrix();
	}
